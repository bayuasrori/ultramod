...
class TasksServiceProvider extends ServiceProvider implements MenuProvider, Uninstallable
{
    ...
    public function boot(): void
    {
        ...
        $this->loadViewsFrom($this->appPath('resources/views'), 'tasks');
